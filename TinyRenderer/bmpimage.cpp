...
BMPImage::BMPImage(int width, int height, int bytesPerPixel) : data(NULL), width(width), height(height), bytesPerPixel(bytesPerPixel) {
    unsigned long nbytes = width * height * bytesPerPixel;
    data = new unsigned char[nbytes];
    memset(data, 0, nbytes);
}

void BMPImage::save(char* fileName) {
